    ...
    return (
        <div className="bg-[#fcf9f9]  font-rubik px-5 pt-20">
            <div className="flex flex-col justify-center items-center gap-3  ">
                ...
                <p className="text-center font-[500] text-[12.1px] px-2 padding-[16.46px] opacity-75 md:text-[22px] md:leading-[29.92px] md:w-[1217px]">
                    We are here to help! Here are some of the most common questions about BloxReward. If you do not see your question here, feel free to reach out to us anytime.
                </p>
