...
export default function () {
    return (
        <div className="bg-[#fcf9f9] flex flex-col justify-center items-center gap-3 font-rubik px-5 pb-16">
            ...
            <p className="text-center font-[500] text-[12.1px] md:text-[22px] md:leading-[29.92px] md:w-[803px] md:pt-3 px-2 pb-4 padding-[16.46px] opacity-75 text-[#161c18] ">We’ve partnered with top offerwalls and survey providers to bring you the best opportunities to earn Robux. Here’s who we work with:</p>
            <div>
